...
#define ARTSSETMEMSHOTTYPE(type)                                               \
  if (artsInternalInspecting())                                                \
...
#define artsMETRICNAME                                                         \
  const char *const artsMetricName[] = {                                       \
      "artsEdtThroughput",                                                     \
      "artsEdtQueue",                                                          \
      "artsEdtStealAttempt",                                                   \
      "artsEdtSteal",                                                          \
...
#define artsGetPerformanceMetricTotal(type, level)                             \
  artsInternalGetPerformanceMetricTotal(type, level)
#define artsGetPerformanceMetricRate(type, level, last)                        \
  artsInternalGetPerformanceMetricRate(type, level, last)
#define artsGetPerformanceMetricTotalRate(type, level)                         \
  artsInternalGetPerformanceMetricTotalRate(type, level)
#define artsGetPerformanceMetricRateU64(type, level, last)                     \
  artsInternalGetPerformanceMetricRateU64(type, level, last)
#define artsGetPerformanceMetricRateU64Diff(type, level, diff)                 \
  artsInternalGetPerformanceMetricRateU64Diff(type, level, diff)
#define artsGetTotalMetricRateU64(type, level, total, timeStamp)               \
  artsInternalGetTotalMetricRateU64(type, level, total, timeStamp)
#define artsSingleMetricUpdate(type, level, toAdd, sub, metric)                \
  artsInternalSingleMetricUpdate(type, level, toAdd, sub, metric)
#define artsUpdatePerformanceMetric(type, level, toAdd, sub)                   \
  artsInternalUpdatePerformanceMetric(type, level, toAdd, sub)
#define artsUpdatePerformanceCoreMetric(core, type, level, toAdd, sub)         \
  artsInternalUpdatePerformanceCoreMetric(core, type, level, toAdd, sub)
#define artsWriteMetricShotFile(threadId, nodeId)                              \
  artsInternalWriteMetricShotFile(threadId, nodeId)
#define artsHandleRemoteMetricUpdate(type, level, toAdd, sub)                  \
  artsInternalHandleRemoteMetricUpdate(type, level, toAdd, sub)
...
#define artsPacketStats(totalBytes, totalPackets, minPacket, maxPacket)        \
  artsInternalPacketStats(totalBytes, totalPackets, minPacket, maxPacket)
#define artsIntervalPacketStats(totalBytes, totalPackets, minPacket,           \
                                maxPacket)                                     \
  artsInternalIntervalPacketStats(totalBytes, totalPackets, minPacket,         \
                                  maxPacket)
#define artsSetThreadPerformanceMetric(type, value)                            \
  artsInternalSetThreadPerformanceMetric(type, value)
